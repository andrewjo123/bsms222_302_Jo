...
m and s. The rest of the symbols in the formula represent the interval ends that we determine, a and b , and known mathematical constants  π  and  e. These two parameters, m and s , are referred to as the average (also called the mean) and the standard deviation (SD) of the distribution respectively.
...
So about 50% are shorter or equal to 69 inches. This implies that if  p=
0.50  then  q=69.5.
...
Define a vector of  m  proportions  p1,p2,…,pm. Define a vector of quatiles  q1,…,qm  for your data for the proportions  p1,…,pm . We refer to these as the sample quantiles.
