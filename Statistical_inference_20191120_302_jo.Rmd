...
Awarded	a	b
Not Awarded	c	d
In this case, the odds ratio is  a/cb/d  which is equivalent to  (ad)/(bc)
...
These are not t-tests so the connection between p-value and confidence intervals does not apply.
