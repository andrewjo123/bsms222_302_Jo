...
##3.3 Exercises
What is the sum of the first 100 positive integers? The formula for the sum of integers  and then use R to compute the sum of  1 through 100 using the formula.
